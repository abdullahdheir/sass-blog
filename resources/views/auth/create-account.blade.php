...
<div class="bg-surface-container-lowest border border-outline-variant p-8 md:p-10 rounded-lg shadow-[0_20px_30px_-10px_rgba(0,0,0,0.05)]">
<div class="text-center py-20">
<h1 class="font-headline-md text-headline-md text-on-surface mb-4">Create Account</h1>
